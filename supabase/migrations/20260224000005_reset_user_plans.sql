-- ============================================================================
-- RESET USER PLANS - Clean slate for testing adaptive system
-- ============================================================================
-- This migration allows resetting a specific user's data for testing
-- IMPORTANT: This is for development/testing only

-- Function to reset a user's adaptive plan data
